...
const create_departmentstaff_dto_1 = require("./dto/create-departmentstaff.dto");
const update_department_dto_1 = require("./dto/update-department.dto");
const update_departmentstaff_dto_1 = require("./dto/update-departmentstaff.dto");
let DepartmentController = class DepartmentController {
    ...
    createDepartmentStaff(createDepartmentStaffDto) {
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_departmentstaff_dto_1.CreateDepartmentStaffDto]),
    __metadata("design:returntype", void 0)
], DepartmentController.prototype, "createDepartmentStaff", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], DepartmentController.prototype, "findAllDepartmentStaff", null);
__decorate([
    (0, common_1.Get)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], DepartmentController.prototype, "findOneDepartmentStaff", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_departmentstaff_dto_1.UpdateDepartmentStaffDto]),
    __metadata("design:returntype", void 0)
], DepartmentController.prototype, "updateDepartmentStaff", null);
__decorate([
    (0, common_1.Delete)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], DepartmentController.prototype, "removeDepartmentStaff", null);
